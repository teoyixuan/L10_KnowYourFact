...
public class Frag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnChange = v.findViewById(R.id.btnChange1);
        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (color == true){
                    ...
                    ll1.setBackgroundColor(getResources().getColor(android.R.color.holo_orange_light));
                    color = false;
                } else if (color == false){
                    Log.d("asdsdsdsd", "orange: ");
                    ll1.setBackgroundColor(getResources().getColor(android.R.color.holo_blue_bright));
                    color = true;
                } else {
